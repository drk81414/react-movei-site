...
* Directory structure
#+ATTR_HTML: :margin-left: auto
[[file:Readme-images/Src-Structure.png]]

*** Components
The Components folder contains all the small individual \\
Components which come together to form the website
*** Common
The Common folder contains all the components which \\
were used more than once on several pages
*** Hooks
The Hooks folder contains function which perform certains \\
